                ...
                <div className="col-md-12 site-col">
                    <div className="site-div">
                        ...
                        <div className="info-overlay">
                            ...
                            <hr />
                            <p className="info"><span className="bold">Role:</span> Sole Developer</p>
                            <p className="info"><span className="bold">Overview:</span> This app uses Node.js to track and adjust inventory, add products, sort by department, change prices and track sales.</p>
                ...
                <div className="col-md-12 site-col">
                    <div className="site-div">
                        ...
                        <div className="info-overlay">
                            ...
                            <p className="info"><span className="bold">Technologies:</span> Firebase, JavaScript, jQuery, HTML, CSS & Bootstrap</p>
                            <div className="info right">
